 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "equalinformation.com", ownerName = "equalinformation.com", packagePath="tools.payment.paypal.testing"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyD2Wd4XuLmxV70q5pMdIR4viL5rALvEnME";
